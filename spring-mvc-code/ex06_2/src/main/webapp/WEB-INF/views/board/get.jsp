	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<!-- authentication 태그 매번 사용하기 번거로우므로 변수 선언 -->
				<sec:authentication property="principal" var="pinfo"/>
				
				<!-- isAuthenticated() : 인증받은 사용자만 영향 받기 위해 지정 -->
				...
				<form id='operForm' action="/board/modify" method="get"><!-- 페이지와 검색 정보 -->
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<!-- isAuthenticated() : 인증받은 사용자(=로그인 성공한 사람)만 댓글쓰기 가능 -->
				<sec:authorize access="isAuthenticated()">
...
$(document).ready(function(){
	...
	//--------------------------------------------------
	// 댓글 등록 : CSRF 토큰 같이 전송
	// 댓글 수정/삭제 : 보안 점검을 위해 댓글 번호와 '댓글 작성자'를 같이 전송한다
	//--------------------------------------------------
	var replyer = null;
	...
	$("#addReplyBtn").on('click', function(e){
		...
		modal.find("input[name='replyer']").val(replyer); // 댓글작성자 = 로그인한 사용자
	...
	//--------------------------------------------------
	// Ajax 로 CSRF 토큰 전송 - 기본 설저으로 지정해서 사용
	// ajaxSend() 를 이용한 코드는 모든 Ajax 전송 시, CSRF 토큰을 같이 전송하도록 세팅되므로
	// 매번 beforeSend 를 호출해야하는 번거로움을 줄일 수 있다
